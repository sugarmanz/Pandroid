...
object UserLogin : BaseMethod() {
    ...
    data class ResponseBody(
        ...
        val listeningTimeoutMinutes: String? = null,
        val stationCreationAdUrl: String? = null,
        val hasAudioAds: Boolean? = null,
        val splashScreenAdUrl: String? = null,
        val videoAdUrl: String? = null,
        val nowPlayingAdUrl: String? = null,
        val maxStationsAllowed: Int? = null,
        val listeningTimeoutAlertMsgUri: String? = null,
        val userProfileUrl: String? = null,
        val minimumAdRefreshInterval: Int? = null,
    )
}